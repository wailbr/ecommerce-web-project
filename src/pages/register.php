...
<head>
  <meta charset="UTF-8">
  <title>Inscription - NeoMarket</title>
      ...
      <div class="formbg-outer">
        <div class="formbg">
          <div class="formbg-inner padding-horizontal--48">
            <span class="padding-bottom--15">Créer un compte NeoMarket</span>
            <br/>
            ...
            <form id="register-form">
              ...
              <div class="field">
                <p style="text-align:center">Déjà inscrit ? <a href="login.php">Connecte-toi ici</a></p>
              </div>
            </form>
          </div>
        </div>
...
<!-- Script Firebase + enregistrement -->
<script>
